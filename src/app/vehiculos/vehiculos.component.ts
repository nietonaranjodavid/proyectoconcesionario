...
export class VehiculosComponent implements OnInit {
  ...
  /*getMisDatos() {
    this.vehiculoService.getMisDatos().subscribe(vehiculos => {
      this.vehiculosApi = vehiculos;
      for (let vehiculo of this.vehiculosApi) {
        let n = new vehiculo(
          vehiculo._id,
          vehiculo._nombre,
          vehiculo._precio,
        ...
        this.vehiculos.push(n);
      }
    });
  }*/
  /*getvehiculosApi() {
    this.messageService.add("Usted está viendo un listado de los vehiculos");
